...
# additional introduction paragraph regarding previous work on linkage analyses and tree hidden markov models

We are motivated by the need to better quantify cell drug response especially when  
