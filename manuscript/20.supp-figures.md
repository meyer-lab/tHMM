...
![**The stacked chart for abundance of the three states in different conditions.** (a) Control condition, (b) 25 nM lapatinib (c) 50 nM ,lapatinib, and (d) 250 nM lapatinib treatment. (e) Control condition, (f) 5 nM gemcitabine, (g) 10 nM gemcitabine, and (h) 30 nM gemcitabine treatment.](figureS15.svg){#fig:abundance tag="S15"}