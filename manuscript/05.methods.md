...
In Fig. {@fig:performSyn}, the accuracy in estimating the Bernoulli parameters for the G1 and S/G2 phase was calculated by dividing the number of cells assigned to a certain state by the model predictions with its predetermined values, which were obtained from our measurements of AU565. 
