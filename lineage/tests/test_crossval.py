...
def test_cv(censored, num_cells):
    complete_lineages = [[LineageTree.init_from_parameters(pi, T, E, num_cells, censor_condition=censored, desired_experiment_time=150) for _ in range(10)] for _ in range(4)]
