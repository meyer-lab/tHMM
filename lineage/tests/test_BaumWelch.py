...
def test_E_step(cens):
    ...
    for _ in range(200):
        ...
        X = LineageTree.init_from_parameters(pi3, T3, E3, desired_num_cells=(2 ** 9) - 1, desired_experimental_time=300, censor_condition=cens)
    ...
    assert rand_score(true_states, pred_states[0]) >= 0.85
