...
class TestModel(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.lineage_gamma = LineageTree(self.pi, self.T, self.E_gamma, 2**11)
        ...
        self.lineage_expon = LineageTree(self.pi, self.T, self.E_expon, 2**11)
        ...
        lineage_gamma_censored = LineageTree(self.pi, self.T, self.E_gamma, 2**11, censor_condition=3, desired_experiment_time=100)
