...
class TestModel(unittest.TestCase):
    ...
    def test_estimationEvaluationGammaCensored(self):
        ...
        Gamma censored.
        """
        self.assertGreater(10., abs(self.gamma_state_censored_estimate.params[1] - self.E_gamma[0].params[1]))
        self.assertGreater(10., abs(self.gamma_state_censored_estimate.params[2] - self.E_gamma[0].params[2]))
