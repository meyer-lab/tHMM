"""
File: figure25.py
Purpose: Generates figure 25.
Figure 25 analyzes heterogeneous (2 state), censored (by both time and fate),
...
def accuracy():
    ...
    for num in num_lineages:
        ...
        for _ in range(num):
            good2go = False
            while not good2go:
                tmp_lineage = LineageTree.init_from_parameters(pi, T, E2, min_desired_num_cells, censor_condition=3, desired_experiment_time=min_experiment_time)
