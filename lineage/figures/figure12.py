...
def distributionPlot():
    ...
    dist1 = np.concatenate((sp.gamma.rvs(a=a0[9], loc=gamma_loc, scale=scale0[9],
                                         size=500), sp.gamma.rvs(a=a1[9], loc=gamma_loc, scale=scale1[9],
                                                                 size=500), 
                            sp.gamma.rvs(a=a0[8], loc=gamma_loc, scale=scale0[8],
    ...
    dists['hues'] = 500 * [1] + 500 * [2] + 500 * [1] + 500 * [2] + 500 * [1] + 500 * [2] + 500 * [1] + 500 * [2] \
        + 500 * [1] + 500 * [2] + 500 * [1] + 500 * [2] + 500 * [1] + 500 * [2] + 500 * [1] + 500 * [2] + 500 * [1] + 500 * [2] \
        + 500 * [1] + 500 * [2]
    return dists
