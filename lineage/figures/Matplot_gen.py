...
def Matplot_gen(ax, x, acc_h1, bern_MAS_h1, bern_2_h1, MASlocBern, locBern2, cGom_MAS_h1, cGom_2_h1, MAScGom, cGom2, scaleGom_MAS_h1, scaleGom_2_h1, MASscaleGom, scaleGom2, xlabel):
    ...
    ax[1].set_ylabel('Bernoulli', rotation=90, fontsize = font2)
    ...
    ax[2].set_ylabel('Gompertz C', rotation=90, fontsize = font2)
    ...
    ax[2].set_title('Gompertz C', fontsize = font)
    ax[2].tick_params(axis='both', which='major', labelsize=10, grid_alpha=0.4)


    #ax = axs[1, 1]
    ax[3].set_xlabel(xlabel, fontsize = font2)
    ...
    ax[3].set_ylabel('Gompertz Scale', rotation=90, fontsize = font2)
    ...
    ax[3].set_title('Gompertz Scale', fontsize = font)
    ax[3].tick_params(axis='both', which='major', labelsize=10, grid_alpha=0.4)
