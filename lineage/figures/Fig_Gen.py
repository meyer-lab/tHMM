...
def Lineage_Length(T_MAS=600, T_2=200, reps=200, MASinitCells=[1], MASlocBern=[0.999], MASbeta=[100], initCells2=[1], locBern2=[0.8], beta2=[16], numStates=2, max_lin_length=300, min_lin_length=5, FOM='E', verbose=False):
...
def Lineages_per_Population_Figure(lineage_start=1, lineage_end=20, numStates=5, T_MAS=400, T_2=100, reps=1, MASinitCells=[1], MASlocBern=[0.8], MASbetaExp=[80], initCells2=[1], locBern2=[0.99], betaExp2=[20], max_lin_length=300, min_lin_length=5, FOM='E', verbose=True):
