...
def Lineage_Length(T_MAS=255, T_2=175, reps=2, MASinitCells=[1], MASlocBern=[0.99], MASbeta=[50], initCells2=[1],
                   locBern2=[0.8], beta2=[25], numStates=2, max_lin_length=100, min_lin_length=5, FOM='E', verbose=False):
