...
Figure 1 is the distribution of cells in a state over generations (unrpuned).
"""
import numpy as np
...
def makeFigure():
    ...
    for i in range(25):
        population.append(LineageTree(pi, T, E, (2**12) - 1, desired_experiment_time=desired_experiment_time, prune_condition='fate', prune_boolean=False))
