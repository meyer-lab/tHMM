...
def accuracy():
    ...
    for num in num_lineages:
        ...
        for _ in range(num):
            good2go = False
            while not good2go:
                tmp_lineage = LineageTree.init_from_parameters(pi, T, E1, min_desired_num_cells, censor_condition=3, desired_experiment_time=min_experiment_time)
    ...
    return commonAnalyze(list_of_populations, list_of_fpi=list_of_fpi, list_of_fT=list_of_fT, list_of_fE=list_of_fE, parallel=False)
