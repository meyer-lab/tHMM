...
from .figureCommon import getSetup, subplotLabel, commonAnalyze, figureMaker, pi, E, max_desired_num_cells, num_data_points
...
def accuracy():
    ...
    list_of_Ts = [np.array([[i,1.0-i],[i,1.0-i]]) for i in np.linspace(0.0, 1.0, num)]
    list_of_populations = []
    for T in list_of_Ts:
        population = []
