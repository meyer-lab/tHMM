...
#     figure_maker(ax, x_unpruned, accuracies_unpruned, bern_unpruned, bern_p0, bern_p1, gamma_a_unpruned, gamma_a0, gamma_a1, gamma_scale_unpruned, gamma_scale0, gamma_scale1, x_pruned, accuracies_pruned, bern_pruned, gamma_a_pruned, gamma_scale_pruned)
    ...
    figure_makerG(ax, x_unpruned, x_pruned, accuracies_unpruned, bern_unpruned, bern_p0, bern_p1, gamma_aG1_unpruned, gamma_aG2_unpruned, gamma_aG11, gamma_aG12, gamma_aG21, gamma_aG22, gamma_scaleG1_unpruned, gamma_scaleG2_unpruned, gamma_scaleG11, gamma_scaleG12, gamma_scaleG21, gamma_scaleG22, accuracies_pruned, bern_pruned, gamma_aG1_pruned, gamma_scaleG1_pruned, gamma_aG2_pruned, gamma_scaleG2_pruned)
...
def accuracy_increased_cellsG():
    ...
    print("gamma a g1 unpruned", gamma_aG1_unpruned)
...
def figure_makerG(ax, x_unpruned, x_pruned, accuracies_unpruned, bern_unpruned, bern_p0, bern_p1, gamma_aG1_unpruned, gamma_aG2_unpruned, gamma_aG11, gamma_aG12, gamma_aG21, gamma_aG22, gamma_scaleG1_unpruned, gamma_scaleG2_unpruned, gamma_scaleG11, gamma_scaleG12, gamma_scaleG21, gamma_scaleG22, accuracies_pruned, bern_pruned, gamma_aG1_pruned, gamma_scaleG1_pruned, gamma_aG2_pruned, gamma_scaleG2_pruned):
    ...
    ax[2].axhline(y=gamma_aG21, linestyle=(0, (3, 5, 1, 5, 1, 5)), linewidth=2, color='g', alpha=0.6)
    ax[2].axhline(y=gamma_aG22, linestyle=(0, (3, 5, 1, 5, 1, 5)), linewidth=2, color='m', alpha=0.6)
    ax[2].set_title('Gamma', fontsize=font)
    ax[2].tick_params(axis='both', which='major', labelsize=10, grid_alpha=0.25)
    ax[2].legend(loc='best', framealpha=0.3)
    ...
    ax[3].scatter(x_unpruned, res[2], c='g', marker="o", label='Susceptible Unpruned G2', alpha=0.5)
    ...
    ax[6].scatter(x_pruned, res[2], c='g', marker="o", label='Susceptible Pruned G2', alpha=0.5)
    ax[6].scatter(x_pruned, res[3], c='m', marker="o", label='Resistant Pruned G2', alpha=0.5)
    ax[6].set_ylabel(r'Gamma a $\beta$', rotation=90, fontsize=font2)
    ax[6].axhline(y=gamma_aG11, linestyle=(0, (3, 5, 1, 5, 1, 5)), linewidth=2, color='b', alpha=0.6)
    ax[6].axhline(y=gamma_aG12, linestyle=(0, (3, 5, 1, 5, 1, 5)), linewidth=2, color='r', alpha=0.6)
    ax[6].axhline(y=gamma_aG21, linestyle=(0, (3, 5, 1, 5, 1, 5)), linewidth=2, color='g', alpha=0.6)
    ax[6].axhline(y=gamma_aG22, linestyle=(0, (3, 5, 1, 5, 1, 5)), linewidth=2, color='m', alpha=0.6)
    ax[6].set_title('Gamma', fontsize=font)
    ax[6].tick_params(axis='both', which='major', labelsize=10, grid_alpha=0.25)
    ax[6].legend(loc='best', framealpha=0.3)
    ...
    ax[7].scatter(x_pruned, res[2], c='g', marker="o", label='Susceptible Pruned G2', alpha=0.5)
